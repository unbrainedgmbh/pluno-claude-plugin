...
- Claude in Chrome.
- The Pluno Chrome extension, signed in to an active Pluno workspace.
...
If plugins are unavailable on your Claude plan, use the downloadable Pluno Browser Tasks skill from the Claude connection page in Pluno.
